...
public class LandingPage extends JFrame implements MouseListener, MouseMotionListener, KeyListener, WindowListener, ItemListener {
    /**
	 *
	 */
    ...
    public static void main(String[] args) {
        LandingPage loginScreen = new LandingPage();
